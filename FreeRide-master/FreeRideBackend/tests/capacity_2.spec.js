...
describe('Capacity 2', () => {
  ...
  describe('Capacity without ADA', () => {
    ...
    it('Should not assign driver 1 to request with 1 passenger with ADA', async () => {
      await createRequest(
    ...
    it('Should not assign driver 1 to request with 6 passengers', async () => {
    ...
    it('Should assign driver 1 to request with 1 passenger after 4 passengers', async () => {
      await createRequest(
    ...
    it('Should assign driver 1 to request with 1 passengers after 4 passengers', async () => {
      await createRequest(
        rider1Token, keyLoc.req1p, keyLoc.req1d, location, app, request, domain, false, 4
      );
      await driverSearcher.search();
    ...
    it('Should assign driver 1 to request with 1 passenger after 5 passengers', async () => {
      await createRequest(
    ...
    it('Should assign driver 1 to request with 5 passengers after 5 passengers', async () => {
      await createRequest(
        rider1Token, keyLoc.req1p, keyLoc.req1d, location, app, request, domain, false, 5
      );
      await driverSearcher.search();
