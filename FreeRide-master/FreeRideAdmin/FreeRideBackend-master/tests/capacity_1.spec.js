...
describe('Capacity 1', () => {
  ...
  describe('Capacity with ADA', () => {
    ...
    it('Should assign driver 1 to request with 1 passenger with ADA after 1 passenger with ADA but not a third', async () => {
      await createRequest(
      ...
      await createRequest(
        rider3Token, keyLoc.req2p, keyLoc.req2d, location, app, request, domain, true, 1
      );
      await driverSearcher.search();
    ...
    it('Should not assign driver 1 to request with 1 passenger not ADA after 1 passenger ADA', async () => {
      await createRequest(
        rider1Token, keyLoc.req1p, keyLoc.req1d, location, app, request, domain, true, 1
      );
      await driverSearcher.search();
    ...
    it('Should not assign ada driver to request with 1 passenger not ADA', async () => {
      await createRequest(
